...
SRC_URI_VC1D = '${@oe.utils.conditional("USE_VC1D_OMX", "1", "file://RTM8RC0000ZMD3LQ00JPL3E.tar.bz2", "", d )}'
SRC_URI_DIVXD = '${@oe.utils.conditional("USE_DIVXD_OMX", "1", "file://RTM8RC0000ZMD7LQ00JPL3E.tar.bz2", "", d )}'
SRC_URI_RVD = '${@oe.utils.conditional("USE_RVD_OMX", "1", "file://RTM8RC0000ZMD6LQ00JPL3E.tar.bz2", "", d )}'
...
OMX_VC1_DEC_SRC = '${@oe.utils.conditional("USE_VC1D_OMX", "1", "RTM8RC0000ZMD3LQ00JPL3E", "", d )}'
OMX_DIVX_DEC_SRC = '${@oe.utils.conditional("USE_DIVXD_OMX", "1", "RTM8RC0000ZMD7LQ00JPL3E", "", d )}'
OMX_RV_DEC_SRC = '${@oe.utils.conditional("USE_RVD_OMX", "1", "RTM8RC0000ZMD6LQ00JPL3E", "", d )}'
OMX_VP8_DEC_SRC = '${@oe.utils.conditional("USE_VP8D_OMX", "1", "RTM8RC0000ZMD8LQ00JPL3E", "", d )}'
OMX_VP8_ENC_SRC = '${@oe.utils.conditional("USE_VP8E_OMX", "1", "RTM8RC0000ZME8LQ00JPL3E", "", d )}'
OMX_VP9_DEC_SRC = '${@oe.utils.conditional("USE_VP9D_OMX", "1", "RTM8RC0000ZMD9LQ00JPL3E", "", d )}'
