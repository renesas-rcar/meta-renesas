...
#                 <software_name>,<package_name>,<copy_file_name> \
#                 <software_name>,<package_name>,<copy_file_name>"
_video_dec_list="H264_decoder,EVARTM0AC0000XV264D30SL40C,EVARTM0AC0000XV264D30SL40C.tar.bz2 \
...
func_audio_lib()
{
    ...
    do
        ...
        if [ -z "${_find_filename}" ]; then
            ...
            pkg_name=`echo $pkg_name | cut -b4-200`
...
func_search_omx_common()
{
    ...
    func_search_and_md5check "EVARTM0AC0000XCMCTL30SL40C" \
        "EVARTM0AC0000XCMCTL30SL40C.tar.bz2" "${_MD5_EVARTM0AC0000XCMCTL30SL40C}" "${_src_full}"
...
func_install_omx_common()
{
    if [ ${_omx_common_install} -eq 0 ]; then
        ...
        install -d ${_OMX_UM_INST_DIR}
        install -m 644 ${_omx_common_top_dir}/EVARTM0AC0000XCMCTL30SL40C/Software/EVARTM0AC0000XCMCTL30SL40C.tar.bz2 ${_OMX_UM_INST_DIR}
        install -d ${_UVCS_INST_DIR}
        echo "                : EVARTM0AC0000XCMCTL30SL40C"
...
func_video_decoder_lib()
{
    ...
    func_search_and_md5check "EVARTM0AC0000XVCMND30SL40C" \
        "EVARTM0AC0000XVCMND30SL40C.tar.bz2" "${_MD5_EVARTM0AC0000XVCMND30SL40C}" "${_src_full}"
    ...
    do
        ...
        if [ -z "${_find_filename}" ]; then
            ...
            if [ ${_video_decoder_common_install} -eq 0 ]; then
                ...
                install -m 644 ${video_decoder_common_top_dir}/EVARTM0AC0000XVCMND30SL40C/Software/EVARTM0AC0000XVCMND30SL40C.tar.bz2 ${_OMX_UM_INST_DIR}
                echo "                : EVARTM0AC0000XVCMND30SL40C"
            fi
...
func_video_encoder_lib()
{
    ...
    func_search_and_md5check "EVARTM0AC0000XVCMNE30SL40C" \
        "EVARTM0AC0000XVCMNE30SL40C.tar.bz2" "${_MD5_EVARTM0AC0000XVCMNE30SL40C}" "${_src_full}"
    ...
    do
        ...
        if [ -z "${_find_filename}" ]; then
            ...
            if [ ${_video_encoder_common_install} -eq 0 ]; then
                ...
                install -m 644 ${video_encoder_common_top_dir}/EVARTM0AC0000XVCMNE30SL40C/Software/EVARTM0AC0000XVCMNE30SL40C.tar.bz2 ${_OMX_UM_INST_DIR}
                echo "                : EVARTM0AC0000XVCMNE30SL40C"
            fi
