...
SRCREV = "d2c569650fa981de831fa341ddc35f27ca965316"
...
ATFW_OPT_r8a7795 = "LSI=H3 RCAR_DRAM_SPLIT=1 RCAR_DRAM_LPDDR4_MEMCONF=0 RCAR_BL2_DCACHE=1 ${ATFW_OPT_LOSSY}"
ATFW_OPT_r8a7796 = "LSI=M3 RCAR_DRAM_SPLIT=2 RCAR_BL2_DCACHE=1 ${ATFW_OPT_LOSSY}"
ATFW_OPT_r8a77965 = "LSI=M3N RCAR_BL2_DCACHE=1 ${ATFW_OPT_LOSSY}"
ATFW_OPT_r8a77990 = "LSI=E3 RCAR_SA0_SIZE=0 RCAR_AVS_SETTING_ENABLE=0 RCAR_DRAM_DDR3L_MEMCONF=0 RCAR_DRAM_DDR3L_MEMDUAL=0 RCAR_BL2_DCACHE=1"
ATFW_OPT_r8a77995 = "LSI=D3 RCAR_SA0_SIZE=0 RCAR_AVS_SETTING_ENABLE=0 PMIC_ROHM_BD9571=0 RCAR_SYSTEM_SUSPEND=0 DEBUG=0 RCAR_BL2_DCACHE=1"
