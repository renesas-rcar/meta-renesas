DESCRIPTION = "VSP Manager for the R-Car Gen5"
...
SRCREV = "ef113315b13ee7bc31d2172eb95c532441a8225f"
...
do_install () {
    ...
    #install -m 644 ${S}/${VSPM_DRV_DIR}/include/vspm_public.h ${D}/${includedir}/
}
